      ...
      config = mkIf cfg.enable {
        warnings =
          let
            ...
            keyboardsWithEmptyDevicesAndNoExclusions = filterAttrs (
              name: keyboard: keyboard.devices == [ ] && keyboard.excludeDevices == [ ]
            ) cfg.keyboards;
            existEmptyDevices = length (attrNames keyboardsWithEmptyDevices) > 0;
            existEmptyDevicesWithoutExclusions =
              length (attrNames keyboardsWithEmptyDevicesAndNoExclusions) > 0;
