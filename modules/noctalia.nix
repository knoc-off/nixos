{ inputs, self }: let
  # Shared between NixOS and HM — single source of truth for the noctalia package
  noctaliaPkg = system: inputs.noctalia.packages.${system}.default.override {
...
in {
  nixos = { config, lib, pkgs, ... }: {
    ...
    services.noctalia-shell = {
      ...
      package = lib.mkForce (noctaliaPkg pkgs.stdenv.hostPlatform.system);
    };
