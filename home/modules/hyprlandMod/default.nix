  ...
  options = {
    hyprland = {
      ...
      fuzzle = {
        ...
        type = with types; bool;
        description = ''
          Enable Fuzzle for launching applications
        '';
      ...
      wallpaper = {
        ...
        path = {
          ...
          description = ''
            Add a wallpaper, must be an image.
          '';
        };
      };
      ...
      swaylock = {
        ...
        type = with types; bool;
        description = ''
        enable swaylock, and some extras
        '';
      };
      ...
      #    description = ''
      #      srings, plugins to install.
      #    '';
      #  };
      #  scratchpads = {
      #    default = {};
      #    type = with types; setType;
      #  };
      #};
    };
  };
  ...
  config = mkIf cfg.enable {
    wayland.windowManager.hyprland = {
      ...
      in
      {
        ...
        #++ (if cfg.wallpaper.enable then "hyprpaper --config ${wallpaper}" else "");
