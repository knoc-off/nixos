# I stole this from here: https://github.com/Toqozz/wired-notify/issues/63
# https://github.com/oddlama/nix-config/blob/729949e218121575e4fc836c06422afae1625c9f/users/myuser/graphical/wired-notify.nix
{
  config,
  lib,
  pkgs,
